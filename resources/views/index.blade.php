      ...
      <header class="mb-auto">
        <div>
          ...
          <nav class="text-dark nav nav-masthead justify-content-center float-md-end">
            <a class="text-dark nav-link fw-bold py-1 px-0 active" aria-current="page" href="{{ url('/') }}">Data Staff</a>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post">
                    @csrf
                    <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label d-none">Id</label>
                      <input type="text" class="form-control d-none" id="edit-id">
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label">Nama</label>
