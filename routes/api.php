...
Route::post('/staff_delete/{id}', [StaffController::class, 'destroy']);
...
Route::post('/student/{id}', [MuridController::class, 'destroy']);
...
Route::post('/bookshelf/{id}', [BookshelfController::class, 'destroy']);
...
Route::post('/borrowed_book/{id}', [BorrowedBookController::class, 'destroy']);
...
// Route::post('/register_murid',[AuthController::class, 'RegisterMurid']);
// Route::post('/register_staff',[AuthController::class, 'RegisterStaff'])->name('register_staff');
// Route::post('/login',[AuthController::class, 'login']);
